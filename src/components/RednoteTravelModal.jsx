          ...
          {activeTab === 'notes' ? (
            <>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="https://www.xiaohongshu.com/user/profile/60011650000000000100204b"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center gap-2 px-4 py-2.5 bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 text-xs font-bold rounded-xl transition-all shadow-xs shrink-0"
                >
                  <span>Official JNTO Portal on XHS</span>
                  ...
                  >
                    <div>
                      ...
                      <div className="p-4 space-y-2.5">
                        <div className="flex items-center justify-between">
                          <a
                            href={note.profileUrl || `https://www.xiaohongshu.com/user/profile/${note.userId || '60011650000000000100204b'}`}
                            target="_blank"
                            rel="noreferrer"
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1">
                              <span className="text-xs font-bold text-slate-800 group-hover/user:text-rose-600 transition-colors">
                                {note.author}
                              </span>
                              {note.verified && (
                                <CheckCircle2 className="w-3.5 h-3.5 text-rose-500 fill-rose-500 text-white shrink-0" />
                              )}
                            </div>
                          </a>
                    ...
                    <div className="px-4 pb-4 pt-1 flex items-center justify-between border-t border-slate-50">
                      <span className="text-[10px] text-slate-400 font-medium">
                        Verified Creator • {note.userId ? `${note.userId.slice(0, 8)}...` : 'Official'}
                      </span>
                      <a
                        href={note.profileUrl || `https://www.xiaohongshu.com/user/profile/${note.userId || '60011650000000000100204b'}`}
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs font-bold text-rose-600 hover:text-rose-700 flex items-center gap-1.5 bg-rose-50 hover:bg-rose-100 px-3 py-1.5 rounded-xl transition-all"
                      >
                        <span>Open on Xiaohongshu</span>
