...
export default function Sidebar({
  ...
  return (
    <aside className="w-72 bg-white border-r border-slate-200/80 flex flex-col justify-between shrink-0 min-h-screen select-none">
      {/* Top Brand Area */}
      <div className="p-6">
      ...
      <div className="p-6 border-t border-slate-100 space-y-4">
        {/* Quick Utility Triggers: News Radar & API Key */}
